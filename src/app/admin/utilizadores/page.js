                      ...
                      <div className="flex flex-wrap gap-2">
                        {aluno.disciplinas.map(disc => (
                          <div 
                            ...
                            className="flex items-center gap-1.5 rounded-md bg-[#4f9eff]/10 pl-2.5 pr-1.5 py-1 border border-[#4f9eff]/20"
                          >
                            <span className="text-[11px] font-medium text-[#4f9eff]">
                            ...
                            <button 
                              ...
                              className="text-[#4f9eff]/60 hover:text-red-400 hover:bg-red-500/20 rounded-md p-0.5 transition"
