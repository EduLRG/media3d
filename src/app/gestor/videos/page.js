      ...
      <div>
        ...
        {disciplinas.length === 0 ? (
          <p className="text-xs text-white/30 py-2">
            Todas as suas disciplinas já têm um vídeo associado.
          </p>
        ) : (
...
export default function GestorVideosPage() {
  ...
  /* ─── Carregar dados filtrados pelas permissões do gestor ────────── */
    ...
    <div className="p-8 max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          ...
          disabled={loading || modulosGestor.length === 0}
      ...
      {/* Mensagem sem módulos */}
      {!loading && modulosGestor.length === 0 && (
        <div className="rounded-xl border border-white/8 bg-[#13131a] py-12 text-center">
      ...
      {editVideo && (
        <EditVideoModal
          ...
          onSave={handleEdit}
          saving={savingEdit}
          todasDisciplinas={modulosGestor}
        />
      )}
