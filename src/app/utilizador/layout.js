...
export default function UtilizadorLayout({ children }) {
  ...
  useEffect(() => {
    async function fetchUser() {
      ...
      // Verificar se tem role de utilizador
      ...
      // Buscar os dados de perfil na tabela utilizadores
  ...
  return (
    <div className="flex min-h-screen bg-[#0c0c0f]">
      ...
      <aside className="flex flex-col w-56 min-h-screen bg-[#13131a] border-r border-white/5 shrink-0">
        ...
        {/* Rodapé: Info do Utilizador e Logout */}
      ...
      <main className="flex-1 overflow-y-auto">
        {/* Removemos o <header> daqui para não haver duplicação com o page.js */}
        {children}
      </main>
